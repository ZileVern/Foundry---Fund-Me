...
```
git clone https://github.com/MAKE_CHANGE/foundry-fund-me
cd foundry-fund-me
make
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/MAKE_CHANGE/foundry-fund-me)
...
There are two typs of testing mentioned below. 
